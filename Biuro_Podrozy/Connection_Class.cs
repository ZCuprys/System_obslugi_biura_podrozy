...
namespace Biuro_Podrozy
{
    ...
    {
        private readonly string connectionString = "Server=10.7.3.202;Database=Biuro_podrozy;User Id=testowy_user;Password=DoZmiany123; TrustServerCertificate=True";
